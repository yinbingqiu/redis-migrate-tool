...
int dictExpand(dict *d, unsigned long size)
{
    ...
    n.table = rmt_calloc(realsize, sizeof(dictEntry*));
    n.used = 0;
...
{
    dictIterator *iter = rmt_alloc(sizeof(*iter));
